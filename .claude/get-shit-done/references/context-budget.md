...
The keys live in `.claude/settings.json` (project) or `/Users/jaybuidl/project/kleros/reputation-oracle/.claude/settings.json` (global) — **not** in `.planning/config.json`:
