...
- Usage: Reference from command with `@/Users/jaybuidl/project/kleros/reputation-oracle/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/jaybuidl/project/kleros/reputation-oracle/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/jaybuidl/project/kleros/reputation-oracle/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
