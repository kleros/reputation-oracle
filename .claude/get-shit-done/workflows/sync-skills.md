...
INSTALL_JS_GLOBAL="/Users/jaybuidl/project/kleros/reputation-oracle/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/jaybuidl/project/kleros/reputation-oracle/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
