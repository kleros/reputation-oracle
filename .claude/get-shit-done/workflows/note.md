...
- **Global scope**: `/Users/jaybuidl/project/kleros/reputation-oracle/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jaybuidl/project/kleros/reputation-oracle/.claude/notes/`)
...
2. Glob `/Users/jaybuidl/project/kleros/reputation-oracle/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jaybuidl/project/kleros/reputation-oracle/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jaybuidl/project/kleros/reputation-oracle/.claude/notes/` — works in any directory
