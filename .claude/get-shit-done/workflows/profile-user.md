...
```bash
cp "/Users/jaybuidl/project/kleros/reputation-oracle/.claude/get-shit-done/USER-PROFILE.md" "/Users/jaybuidl/project/kleros/reputation-oracle/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/jaybuidl/project/kleros/reputation-oracle/.claude/USER-PROFILE.backup.md"
```
