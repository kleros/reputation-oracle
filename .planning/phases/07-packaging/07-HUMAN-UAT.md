...
[awaiting human testing on live Sepolia VPS — use `deploy/ACCEPTANCE.md` as the checklist]
...
_(none identified; all items are live-VPS runtime checks deferred to the operator)_
